...
function checkConsoleLogOutput(ast) {
    ...
    console.log(`\x1b[33mChecking output with console.log\x1b[0m`);
...
function checkStringConcatenation(ast) {
    ...
    // Detailed logging of the check
    console.log(`\x1b[33mChecking string concatenation or template literals usage\x1b[0m`);
...
function gradeAssignment() {
    ...
    testResults.testCaseResults[GUID] = checkConsoleLogOutput(ast);
